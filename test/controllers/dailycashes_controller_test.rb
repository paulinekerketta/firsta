...
class DailycashesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dailycash" do
    assert_difference('Dailycash.count') do
      post dailycashes_url, params: { dailycash: { cashpaid: @dailycash.cashpaid, date: @dailycash.date, discount: @dailycash.discount, driverpaid: @dailycash.driverpaid, lodgement: @dailycash.lodgement, overunder: @dailycash.overunder, purchase: @dailycash.purchase, sale: @dailycash.sale } }
    end
  ...
  test "should update dailycash" do
    patch dailycash_url(@dailycash), params: { dailycash: { cashpaid: @dailycash.cashpaid, date: @dailycash.date, discount: @dailycash.discount, driverpaid: @dailycash.driverpaid, lodgement: @dailycash.lodgement, overunder: @dailycash.overunder, purchase: @dailycash.purchase, sale: @dailycash.sale } }
